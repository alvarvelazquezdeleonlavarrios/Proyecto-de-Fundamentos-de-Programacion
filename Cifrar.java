...
public class Cifrar extends JFrame implements ActionListener {
	JMenuBar barra;
	...
	public Cifrar()
	{
		...
		cifrar.setFont(new Font("Arial",Font.BOLD,18));         
		cifrar.setBounds(130,110,150,30);                         
	...
	{
		setLayout(null);
		setTitle("Cifrado por Desplazamiento");
		setSize(350, 250);
		setResizable(true);
	...
	public void actionPerformed(ActionEvent event) { //evento 
    	if (event.getSource()== cifrar){ //si oprime el botón
	...
	public void creatbar() {
        ...
        instrucciones.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(p1, "Inserta una palabra que requieras cifrar con una contraseña");
            }
        });
